                ...
                <tr>
                                        ...
                                        <tr>
                                            <td height="198" align="right" valign="top">
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="35%">&nbsp;</td>
                                                        <td height="25" colspan="2" class="left_txt"><p>欢迎网站后台管理系统！</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="35%">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%" height="40">
                                                            <img src="images/icon-demo.gif" width="16" height="16"><a href="http://www.xxxxx.com" target="_blank" class="left_txt3">
                                                            返回前台</a></td>
                                                        <td width="35%">
                                                            <img src="images/icon-login-seaver.gif" width="16" height="16"><a href="http://www.vcher.com" class="left_txt3">
                                                            Diaoer</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                    ...
                    <td width="50%" valign="bottom">
                        <table width="100%" height="59" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="4%">&nbsp;</td>
                                <td width="96%" height="38"><span class="login_txt_bt">管理员登录</span><span class="login_error_txt" id="errorMessage"><s:property value="errorMessage"/></span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td height="21">
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table211" height="328">
                                        <tr>
                                            <td height="164" colspan="2" align="middle">
                                                <form name="loginForm" action="admin/userLogin.do" method="post">
                                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0" height="143" id="table212">
                                                        <tr>
                                                            <td width="13%" height="38" class="top_hui_text">
                                                                <span class="login_txt">帐号：&nbsp;&nbsp; </span></td>
                                                            <td height="38" colspan="2" class="top_hui_text">
                                                                <input type="text" name="userName" class="editbox4" size="20">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="13%" height="35" class="top_hui_text">
                                                                <span class="login_txt"> 密码： &nbsp;&nbsp; </span></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="35" colspan="2" class="top_hui_text">
                                                                ...
                                                                <input style="height: 25px;line-height: 25px;" class=wenbenkuang name=verifyCode type="text" maxLength=5 size=10>
                                                                <img id="verifyCodeImage" class="verifyCode" src="/verifyCode.jpg" alt="点击刷新" title="点击刷新" onclick="changeVerifyCode()"/>
                                                                <span class="left_txt">点击图片刷新</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="20%" height="35">
                                                                <input name="Submit" type="reset" class="button" id="reset" value="重置">
                                                            </td>
                                                            <td width="67%" class="top_hui_text">
                                                                <input name="cs" type="submit" class="button" id="submit" value="登录">
                                                            </td>
                                                        </tr>
                                                        <tr>
    ...
    <tr>
        <td height="20">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="login-buttom-bg">
                <tr>
                    <td align="center"><span class="login-buttom-txt">Copyright &copy; 20011-2012 www.asdf.cn</span>
                    </td>
                </tr>
            </table>
        </td>
...
<script type="text/javascript">
    function  changeVerifyCode(){
        document.getElementById("verifyCodeImage").src="verifyCode.jpg?random="+Math.random;
    }
</script>
</body>
</html>